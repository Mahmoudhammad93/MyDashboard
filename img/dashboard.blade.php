...
<div id="page-wrapper dashboard">
				 ...
				 <div class="dashboard">
					 <div class="row">
				 	<div class="col-lg-3 col-md-6 col-sm-12 dbb one">
					...
					<div class="col-lg-3 col-md-6 col-sm-12 dbb two">
				 		<div class="media state-media box-ws">
				 	...
				 	<div class="col-lg-3 col-md-6 col-sm-12 dbb three">
				 		<div class="media state-media box-ws">
				 ...
				 <div class="col-lg-3 col-md-6 col-sm-12 dbb four">
				 		<div class="media state-media box-ws">
				 	 ...
				 	 <div class="col-lg-3 col-md-6 col-sm-12 dbb five">
				 		<div class="media state-media box-ws">
				 	 ...
				 	 <div class="col-lg-3 col-md-6 col-sm-12 dbb six">
				 		<div class="media state-media box-ws">
				 	 ...
				 	 <div class="col-lg-3 col-md-6 col-sm-12 dbb seven">
				 		<div class="media state-media box-ws">
				 		 ...
				 		 <div class="col-lg-3 col-md-6 col-sm-12 dbb eight">
				 		<div class="media state-media box-ws">
